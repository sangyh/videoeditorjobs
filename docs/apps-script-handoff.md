...
10. Confirm it returns `ok: true`, `scriptVersion: "vej-2026-07-20-intake-summary"`, `expectedSeeds: 11`, `presentSeeds: 11`, and no missing headers or seed IDs.
...
{
  "ok": true,
  "scriptVersion": "vej-2026-07-20-intake-summary",
  "communityPosts": {
    "expectedSeeds": 11,
    "presentSeeds": 11,
    "missingSeedIds": [],
...
- the command returns `health.scriptVersion` matching `vej-2026-07-20-intake-summary`
